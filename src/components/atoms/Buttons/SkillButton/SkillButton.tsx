...
const SkillButton = (props: SkillButtonProps) => {
  const mainClass =
    " flex items-center px-3 py-3 cursor-pointer bg-base-100 shadow-md rounded-xl mr-2 mt-2 hover:text-white";
  const gradientClass =
  ...
  return (
    ...
    >
      ...
      <p className="ml-2 text-sm text-base-content">{props.name}</p>
    </a>
  );
};
